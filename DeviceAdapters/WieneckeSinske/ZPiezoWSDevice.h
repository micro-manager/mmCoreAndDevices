///////////////////////////////////////////////////////////////////////////////
// FILE:          ZPiezoWSDevice.h
// PROJECT:       Micro-Manager
// SUBSYSTEM:     DeviceAdapters
//-----------------------------------------------------------------------------
// DESCRIPTION:   Wienecke & Sinske ZPiezo Controller Driver using WS protocol
//             
//
...
//
#ifndef _ZPIEZOWSDEVICE_H_
#define _ZPIEZOWSDEVICE_H_

#include "WSAxis.h"


class ZPiezoWSDevice : public CStageBase<ZPiezoWSDevice>
{
public:
	ZPiezoWSDevice(); 
	~ZPiezoWSDevice(); 
