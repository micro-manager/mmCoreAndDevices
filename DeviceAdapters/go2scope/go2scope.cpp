...
int MMV1Storage::GetSummaryMeta(const char* handle, char* meta, int bufSize)
{
   return 0;
}

int MMV1Storage::GetImageMeta(const char* handle, int coordinates[], int numCoordinates, char* meta, int bufSize)
{
   return 0;
}
