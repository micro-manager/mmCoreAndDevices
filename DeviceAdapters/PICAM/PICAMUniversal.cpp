...
int Universal::BuildMetadata( Metadata& md )
{
   ...
   md.PutImageTag(MM::g_Keyword_Elapsed_Time_ms, CDeviceUtils::ConvertToString(elapsed.getMsec()));

   md.PutImageTag(MM::g_Keyword_Metadata_ImageNumber, CDeviceUtils::ConvertToString(curImageCnt_));
