...
***************************************************************************/
ASICAMERA_API ASI_ERROR_CODE  ASIWriteSonyReg(int iCameraID, unsigned short Addr, unsigned char Value);

#endif // ASIPRODUCE

//#define INNER_TEST //内部测试功能，对内发布，不对外发布，发版前需注释掉
//#define SMLTEST //自己测试的功能，既不对内发布，也不对外发布，发版前需注释掉
