...
#ifndef PI_XYSTAGE_H_INCLUDED
#define PI_XYSTAGE_H_INCLUDED
...
class PIXYStage : public CXYStageBase<PIXYStage>, public PIControllerObserver
{
public:
   PIXYStage ();
   ~PIXYStage ();
   ...
   int OnAxisErrorState (MM::PropertyBase* pProp, MM::ActionType eAct);
   ...
   int OnHID (MM::PropertyBase* pProp, MM::ActionType eAct);
...
private:
   ...
   int OnVelocity (MM::PropertyBase* pProp, MM::ActionType eAct, PIController* controller, std::string& axis);

   int ReadPositions (double& posX, double& posY);
