...
const char* g_SpectrographName = "Andor Shamrock";
...
const char* gsz_DirectIrisPosition = "Direct Port Iris Position";
const char* gsz_SideIrisPosition = "Side Port Iris Position";